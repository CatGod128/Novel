...
<body class="layui-layout-body">
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side custom-admin">
            <div class="layui-side-scroll">
                ...
                <div class="custom-logo">
                    <img src="../html/assets/images/logo.png" alt=""/>
                    <h1>Admin Pro</h1>
                </div>
                <ul id="Nav" class="layui-nav layui-nav-tree">
                    ...
                    <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="/queryPage/crawlImg">爬取图片</a></dd>
                            <dd><a href="/queryPage/crawlNovel">爬取小说</a></dd>
                        </dl>
                    </li>
                </ul>
        ...
        <div class="layui-footer">
            <p>© 2020 Auoth：<a href="http://www.mycodes.net/" target="_blank">Mr.Cat</a></p>
        </div>

        <div class="mobile-mask"></div>
    </div>
    <script src="../html/assets/layui.js"></script>
